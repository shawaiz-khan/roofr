...
export const FooterAboutItems: FooterItemProps[] = [
    { name: "Our Story", path: "/about#our-story" },
    { name: "Our Works", path: "/about#our-works" },
    { name: "How it Works", path: "/about#how-it-works" },
    { name: "Our Team", path: "/about#our-team" },
    { name: "Our Clients", path: "/about#our-clients" },
];

export const FooterPropertiesItems: FooterItemProps[] = [
