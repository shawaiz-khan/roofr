...
const NavBar: React.FC = () => {
    ...
    return (
        <nav className="text-text-light flex flex-col justify-between items-center">
            {isModal &&
                <div className="bg-black-secondary border-b border-gray-tertiary flex justify-center items-center relative overflow-hidden w-full h-full px-3 py-4">
            ...
            <div className="bg-black-secondary w-full px-3 py-4 flex justify-between items-center">
